...
module.exports = (data) ->
  stir.render stir.doctype(),
    html null,
      ...
      body null,
        div class: 'intro',
          div class: 'title', "This is a demo React Lite Space."
          line "It's just a component for generating space with DOM."
          div null,
            span null, "Read more at "
            a href: 'http://github.com/teambition/react-lite-space',
              'github.com/teambition/react-lite-space'
            span null, '.'
        div class: 'demo',
